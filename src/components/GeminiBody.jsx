...
import { Camera, CircleUserRound, Compass, Lightbulb, List, SendHorizonal } from 'lucide-react';
                ...
                {!displayResult ? (
                    <div >
                        ...
                        <div className='h-28 p-4 bg-bgSecondaryColor rounded-xl relative cursor-pointer mb-4'>
                            ...
                            <List size={35} className='p-1 absolute bottom-2 right-2 bg-bgPrimaryColor text-softTextColor rounded-full ' />
                        </div>
                        <div className='h-28 p-4 bg-bgSecondaryColor rounded-xl relative cursor-pointer mb-4'>
                            <p>Evaluate adn rank camera categories</p>
                            <Camera size={35} className='p-1 absolute bottom-2 right-2 bg-bgPrimaryColor text-softTextColor rounded-full ' />
                        </div>
                    </div>
                ) : (<div>
                    ...
                    <form action={submit}>
                        <div className='flex items-center justify-between gap-5 bg-bgSecondaryColor py-2.5 px-5 rounded-full border '>
                            ...
                            <div className='flex cursor-pointer'>
                                <SendHorizonal type="submit" size={20} className='text-green-500' />
                            </div>
                        </div>
                    </form>
                    <p className='text-gray-400 text-sm text-center'>
                        Warning: Gemini may display inaccurate information. Double-check its reponses and always your common sense.
                    </p>
                </div>
